...
# Only 8 numeric features (best setup)
num_cols = [
    "focus_intensity",
    "consistency_score",
...
# META MODEL — SIMPLE UPGRADE
meta = LogisticRegression(
    max_iter=5000,
    class_weight="balanced",
    C=2.0,   # 🔥 upgraded from 1.5 → improves boundaries
    multi_class="multinomial"
)
...
sub.to_csv("submission_simple_v2.csv", index=False)
print("\nSaved submission_simple_v2.csv")
