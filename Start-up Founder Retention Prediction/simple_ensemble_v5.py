...
# ================================================================
# Build features — ONLY OneHot + Raw Numericals
# ================================================================
...
def main():
    ...
    for i in range(500):  # stable & fast
        ...
        if (i + 1) % 100 == 0:
            print(f"  Iter {i+1}/500 | best OOF = {best_acc:.5f}")
    ...
    out = "submission_simple_ensemble_v5.csv"
